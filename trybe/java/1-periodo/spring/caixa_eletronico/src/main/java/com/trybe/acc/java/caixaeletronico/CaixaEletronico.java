...
public class CaixaEletronico {
  ...
  /**
   * Método main do CaixaEletronico. Simula no terminal todas as operações implementadas de saque,
   * transferência, login e outros.
   */
  ...
  public static void main(String[] args) {
    ...
    // pessoa cliente 2
    PessoaCliente pessoaCliente2 = banco.adicionarPessoaCliente("Abadiania Silva", "848.725.510-87",
        "1234");
