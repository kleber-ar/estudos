...
public class TrybeGamesController
{
    ...
    {
    // Lê o nome da pessoa jogadora pelo console
      Console.WriteLine("Digite o nome da pessoa jogadora:");
      string name = Console.ReadLine();

    // Gera o Id automaticamente
      int newId = database.Players.Count + 1;

    // Cria a nova pessoa jogadora
    ...
    {
    // Lê o nome do estúdio pelo console
    ...
    // Tipo do jogo
      ...
      GameType gameType = Enum.Parse<GameType>(Console.ReadLine());

    // Gera o Id automaticamente
      int newId = database.Games.Count + 1;
