...
public class TestReq14 : IClassFixture<WebApplicationFactory<Program>>
{
    public HttpClient _clientRoomPost;

    public TestReq14(WebApplicationFactory<Program> factory)
    {
        //_factory = factory;
