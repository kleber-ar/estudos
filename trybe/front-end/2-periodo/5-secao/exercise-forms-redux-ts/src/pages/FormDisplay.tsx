...
function FormDisplay() {
  ...
  const professional = useSelector((state: any) => state.professionalData);

  const { name, email, cpf, address, city, uf } = personal;
  const { resume, role, description } = professional;
