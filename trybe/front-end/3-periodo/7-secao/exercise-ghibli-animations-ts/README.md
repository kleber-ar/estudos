...
<details>
  ...
  [FORMULÁRIO DE AVALIAÇÃO](https://be-trybe.typeform.com/to/ZTeR4IbH#cohort_hidden=CH34&template=betrybe/sd-0x-exercise-ghibli-animations-ts)
...
- Todos os componentes criados devem ser componentes funcionais.
