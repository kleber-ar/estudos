...
from movies.models import Person, Genre, Movie, MovieTheater, MovieRoom, MovieSeat
...
def test_movie_rooms_table_is_healthy():
    number_of_rooms = len(MovieRoom.objects.all())
    assert number_of_rooms == 1
