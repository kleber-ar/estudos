...
* Use o comando: `git clone git@github.com:tryber/python-001-projeto-tech-news.git`
* Entre na pasta do repositório que você acabou de clonar:
  * `cd python-001-projeto-tech-news`
...
* Vá até a página de _Pull Requests_ do [repositório no GitHub](https://github.com/tryber/python-001-projeto-tech-news/pulls)
...
* Volte até a [página de _Pull Requests_ do repositório](https://github.com/tryber/python-001-projeto-tech-news/pulls) e confira que o seu _Pull Request_ está criado
